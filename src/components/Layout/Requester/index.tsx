...
const RequesterLayout = (props: LayoutProps) => {
  ...
  const menuItems = [
    {
      ...
      color: pathLocation === "/requester/dashboard" ? "#d2435e" : ""
    },
    {
      label: "Request",
      link: "/requester/requests",
      color: pathLocation === "/requester/requests" || pathLocation === "/requester/requests" ? "#d2435e" : ""
    },
